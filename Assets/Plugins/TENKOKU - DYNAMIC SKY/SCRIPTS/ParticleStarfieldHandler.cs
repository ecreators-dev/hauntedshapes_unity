...
namespace Tenkoku.Core
{
		...
		StarSystem.GetParticles(StarParticles);
			...
			for (px = 0; px < StarParticles.Length; px++){
				...
				for (sx = 0; sx < (starData.starElements.Length); sx++){
					...
					if (starData.starElements[sx].decH < 0.0f)
                    {
                        starDeclination = 0.0f-starDeclination;
                    }
					...
					//set star colors
					if (starData.starElements[sx].color == 0)
                    {
                        setColor = Color.Lerp(starColO,starColB,starFactor);
                    }

                    if (starData.starElements[sx].color == 1)
                    {
                        setColor = Color.Lerp(starColB,starColA,starFactor);
                    }

                    if (starData.starElements[sx].color == 2)
                    {
                        setColor = Color.Lerp(starColA,starColF,starFactor);
                    }

                    if (starData.starElements[sx].color == 3)
                    {
                        setColor = Color.Lerp(starColF,starColG,starFactor);
                    }

                    if (starData.starElements[sx].color == 4)
                    {
                        setColor = Color.Lerp(starColG,starColK,starFactor);
                    }

                    if (starData.starElements[sx].color == 5)
                    {
                        setColor = Color.Lerp(starColK,starColM,starFactor);
                    }

                    if (starData.starElements[sx].color == 6)
                    {
                        setColor = Color.Lerp(starColM,starColM,starFactor);
                    }
					...
					setColor.a = 1.0f;
					if (starMagnitude >= 2.0f)
                    {
                        setColor.a = Mathf.Lerp(1.0f,0.0f,(starMagnitude/9.0f));
                    }
					...
					if (ConstellationStar && useSize < constellationSize)
                    {
                        useSize = constellationSize;
                    }
					...
					//polaris star
					if (starData.starElements[sx].starIndex == 8890)
                    {
                        useSize *= 1.25f;
                    }
	...
	public bool CheckConstellationStarData(int starIndex){
		...
		if (starIndex == 8890)
            {
                isConstellationStar = true;  //polaris
            }

            if (starIndex == 153751)
            {
                isConstellationStar = true;  //urodelus
            }

            if (starIndex == 131873)
            {
                isConstellationStar = true;  //kochab
            }

            if (starIndex == 137422)
            {
                isConstellationStar = true;  //pherkad
            }

            if (starIndex == 166205)
            {
                isConstellationStar = true;  //yildun
            }

            if (starIndex == 142105)
            {
                isConstellationStar = true;  //zeta ursae minoris
            }

            if (starIndex == 148048)
            {
                isConstellationStar = true;  //eta ursae minoris
            }
            //big dipper
            if (starIndex == 103287)
            {
                isConstellationStar = true;  //phekda
            }

            if (starIndex == 120315)
            {
                isConstellationStar = true;  //elkeid
            }

            if (starIndex == 116842)
            {
                isConstellationStar = true;  //alcor
            }

            if (starIndex == 106591)
            {
                isConstellationStar = true;  //megrez
            }

            if (starIndex == 95418)
            {
                isConstellationStar = true;  //merak
            }

            if (starIndex == 95689)
            {
                isConstellationStar = true;  //dubhe
            }

            if (starIndex == 112185)
            {
                isConstellationStar = true;  //alioth
            }
            // orion
            if (starIndex == 39801)
            {
                isConstellationStar = true;  //betelgeuse
            }

            if (starIndex == 36861)
            {
                isConstellationStar = true;  //meissa
            }

            if (starIndex == 35468)
            {
                isConstellationStar = true;  //bellatrix
            }

            if (starIndex == 34085)
            {
                isConstellationStar = true;  //rigel
            }

            if (starIndex == 38771)
            {
                isConstellationStar = true;  //saiph
            }

            if (starIndex == 36486)
            {
                isConstellationStar = true;  //mintaka
            }

            if (starIndex == 37742)
            {
                isConstellationStar = true;  //alnitak
            }

            if (starIndex == 37128)
            {
                isConstellationStar = true;  //alnilam
            }
            //taurus
            if (starIndex == 35497)
            {
                isConstellationStar = true;  //elnath
            }

            if (starIndex == 29139)
            {
                isConstellationStar = true;  //aldebaran
            }

            if (starIndex == 28305)
            {
                isConstellationStar = true;  //e taur
            }
            ...
            if (starIndex == 87901)
            {
                isConstellationStar = true;  //regulus
            }
            ...
            if (starIndex == 89484)
            {
                isConstellationStar = true;  //algieba
            }
            ...
            if (starIndex ==  4128)
            {
                isConstellationStar = true;  //deneb kaitos
            }

            if (starIndex ==  14386)
            {
                isConstellationStar = true;  //mira
            }

            if (starIndex ==  18884)
            {
                isConstellationStar = true;  //menkar
            }

            if (starIndex ==  12929)
            {
                isConstellationStar = true;  //hamal
            }
