...
public class SimpleSwitchMaterial : MonoBehaviour {
	...
	public void SwitchMaterial(){
		if (initialMaterials.Length==newMaterials.Length){
			MeshRenderer[] allVisibleMeshRenderers = GameObject.FindObjectsByType<MeshRenderer> (FindObjectsSortMode.InstanceID);
        ...
        {
            Debug.Log ("initial Material variable Array length is different than new Materials variable Array length, please fix :)");
        }
    }
